...
let lastItemRemove = cargoHold.pop();
console.log("Element removed:", lastItemRemove);
...
let frstItemRemove = cargoHold.shift();
console.log("Element removed:", frstItemRemove);
console.log("Updated array:", cargoHold)
