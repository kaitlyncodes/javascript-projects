...
console.log("Entry from first level:", threeDimensionArr[0]);
console.log("Entry from second level:", threeDimensionArr[1][0]);
console.log("Entry from third level:", threeDimensionArr[2][1]);
